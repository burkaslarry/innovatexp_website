...
export function WhyInnovateXP({ title, points }: { title: string; points: WhyPoint[] }) {
  return (
    ...
    >
      <h2 className="mb-8 text-center text-3xl font-bold leading-tight tracking-tight text-oxford dark:text-white sm:text-4xl md:text-5xl">
        {title}
      </h2>
      <ul className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {points.map((p, i) => {
          ...
          return (
            ...
            >
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-oxford/10 text-oxford dark:bg-oxford-light/20 dark:text-[color:var(--primary-hover)]">
