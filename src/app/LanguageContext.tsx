...
export const translations = {
  en: {
    ...
    'pricing.insight.setup': 'One-off setup from HKD $14,000 (Luma integration + operation manual)',
    ...
    'faq.eventxp.a4': 'EventXP Starter is HKD 1,480/month (1 community, 2 onsite events). Growth is HKD 1,980/month with AI Potential Interest Insight and 2 AI consultancy sessions/year. Enterprise is HKD 2,480/month with monthly AI consultancy and 4 onsite events. One-off setup from HKD 14,000.',
  ...
  zh: {
    ...
    'pricing.insight.setup': '一次性設定由 HKD $14,000 起（Luma 整合 + 操作手冊）',
    ...
    'faq.eventxp.a4': 'EventXP Starter 月費 HKD 1,480（1 個社群、2 次現場支援）。Growth 月費 HKD 1,980，含 AI 潛在興趣透視及每年 2 次 AI 諮詢。Enterprise 月費 HKD 2,480，含每月 AI 諮詢及 4 次現場支援。一次性設定由 HKD 14,000 起。',
