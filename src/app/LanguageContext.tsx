...
export const translations = {
  en: {
    ...
    // Hero Section
    'hero.title': 'AI Solutions Trainer & SME AI Workflow Consultant',
    'hero.tagline': 'Hong Kong SME AI workflow automation, AI training, AI coaching, and implementation support by Larry Lo, founder of InnovateXP Limited.',
    'hero.description':
      'We help schools, SMEs, sales teams, event organizers, and business communities turn AI from hype into practical workflows: WhatsApp CRM automation, EventXP, Proposal-to-Cash AI, custom agents, dashboards, and AI 陪跑課程.',
    'hero.cta': 'Contact Us',
    'hero.book_meeting': 'Free 15-min chat',
    'hero.case_studies': 'See case studies',
    'hero.badge.experience': '13+ years hands-on IT delivery',
    'hero.badge.language': 'Cantonese / English support',
    'hero.bottom_tagline': 'AI training, coaching, and systems that empower people to carry AI transformation.',
    ...
    'home.about.body':
      'InnovateXP Limited is a Hong Kong SME AI workflow and training company founded by Larry Lo, AI Solutions Trainer and SME AI Workflow Consultant. We help schools, SMEs, sales teams, event organizers, and business communities adopt AI in real workflows through AI 教班, AI 陪跑課程, SmartSales CRM, EventXP, Proposal-to-Cash AI, custom agents, dashboards, and clean implementation support.',
  ...
  zh: {
    ...
    // Hero Section
    'hero.title': 'AI Solutions Trainer & SME AI Workflow Consultant',
    'hero.tagline': 'Larry Lo / InnovateXP Limited 幫香港中小企、學校同 business teams 做 AI 工作流自動化、AI 教班、AI 陪跑課程同落地實施。',
    'hero.description': '由 WhatsApp CRM 自動化、EventXP、Proposal-to-Cash AI，到 custom AI agents、dashboard、booking/admin portal，我哋幫團隊將 AI 由 hype 變成每日用到嘅工作流程。',
    'hero.cta': '聯絡我們',
    'hero.book_meeting': '免費傾 15 分鐘，睇下啱唔啱你',
    'hero.case_studies': '睇成功案例',
    'hero.badge.experience': '13+ 年 IT delivery 實戰',
    'hero.badge.language': '廣東話／英文支援',
    'hero.bottom_tagline': 'AI 教班、陪跑同系統落地，目標係 empower 團隊一齊 carry AI transformation。',
    ...
    'home.about.body':
      'InnovateXP Limited 由 Larry Lo 創立；Larry 係 AI Solutions Trainer、SME AI Workflow Consultant，具備 13+ 年 IT delivery、mobile apps、cloud architecture、agile delivery 同 AI-powered business systems 經驗，亦係前 GDG Hong Kong Organizer。我哋幫學校、中小企、sales team、活動主辦同 business communities 做 AI 教班、AI 陪跑課程、WhatsApp CRM 自動化、EventXP、Proposal-to-Cash AI、custom agents、dashboard、booking/admin portal 同 clean implementation support。',
