...
export const translations = {
  en: {
    ...
    'pricing.crm.tier2.badge': 'Advanced',
    'pricing.crm.tier2.target': 'Advanced AI features',
  ...
  zh: {
    ...
    'pricing.crm.tier2.badge': '進階版',
    'pricing.crm.tier2.target': '進階 AI 功能',
    ...
    'faq.smartsales.a3': 'SmartSales CRM Starter 計劃月費由 HKD 2,800 起，Pro 進階 AI 計劃月費 HKD 4,800。企業定價取決於用戶數量和整合需求。請聯絡我們獲取定制報價。',
