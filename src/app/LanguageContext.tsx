...
export const translations = {
  en: {
    ...
    // Hero Section
    'hero.title': 'InnovateXP: AI Agent and automation implementation for Hong Kong SMEs',
    'hero.tagline': 'Deploy practical Azure OpenAI-ready workflows that improve follow-up speed and operational visibility.',
    'hero.description':
    ...
    'hero.tagline_en': 'Compliant regional cloud deployment for AI agents, CRM, and workflow automation.',
    ...
    'mockup.pipeline':
      '🎬 See SmartSales CRM interface walkthrough for Hong Kong SMEs — triage, AI drafts, and follow-up execution. → Book Demo: info@innovatexp.com',
    ...
    'wizard.flowx.submit_fail': 'Could not send — email info@innovatexp.com or use WhatsApp.',
    ...
    'pricing.crm.tier3.price': 'Custom',
    'pricing.crm.tier3.period': '(setup pricing)',
    ...
    'pricing.crm.tier3.feature4':
      'Pricing excludes third-party platform fees (hosting, messaging providers, SIM/data plans, SMS/email sending).',
  ...
  zh: {
    ...
    // Hero Section
    'hero.title': 'InnovateXP：為香港中小企落地 AI Agent 與自動化平台',
    'hero.tagline': '以 Azure OpenAI 就緒架構與合規雲端區域部署，改善跟進速度與營運可視性',
    'hero.description': '我們為香港中小企建立可落地的 AI 系統，聚焦實際服務交付，減少漏跟進、慢回覆與資料分散問題。',
    'hero.cta': '聯絡我們',
    ...
    'wizard.flowx.submit_fail': '無法送出 — 請電郵 info@innovatexp.com 或用 WhatsApp。',
    ...
    'pricing.crm.tier3.name': 'Enterprise',
    'pricing.crm.tier3.price': 'Custom',
    'pricing.crm.tier3.period': '(設定費按範圍報價)',
    ...
    'pricing.crm.tier3.feature4': '以上報價未包含第三方平台費（hosting、訊息服務商、SIM/data、SMS/email 發送）。',
