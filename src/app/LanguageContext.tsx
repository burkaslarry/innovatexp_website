...
export const translations = {
  en: {
    ...
    'hero.tagline': 'Embrace a new AI roadmap—reach new heights for your business.',
    'hero.description':
  ...
  zh: {
    ...
    // Hero Section
    'hero.title': '與你同行的 AI 系統顧問',
    'hero.tagline': '用清晰步驟導入 AI，改善日常營運',
    'hero.description': '我們為香港中小企建立可落地的 AI 系統，減少漏跟進、慢回覆與資料分散問題。',
    'hero.cta': '聯絡我們',
