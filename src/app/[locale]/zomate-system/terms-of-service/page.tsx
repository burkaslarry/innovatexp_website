...
import { getZomateTermsOfService } from "@/content/legal-zomate";
...
const PATH = "/zomate-system/terms-of-service";
...
export async function generateMetadata({
  ...
  const content = getZomateTermsOfService(locale);
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Zomate Terms of Service" }],
    },
    twitter: {
...
export default async function ZomateTermsOfServicePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const content = getZomateTermsOfService(loc);
