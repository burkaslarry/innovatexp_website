...
import { getInnovatexpPrivacyPolicy } from "@/content/legal-privacy";
...
export async function generateMetadata({
  ...
  const content = getInnovatexpPrivacyPolicy(locale);
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "InnovateXP Privacy Policy" }],
    },
    twitter: {
...
export default async function PrivacyPolicyPage({
  ...
  const content = getInnovatexpPrivacyPolicy(loc);
