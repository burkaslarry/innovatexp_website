 ...
 */
export const CANONICAL_BOOKING_URL = "https://innovatexp.co/bookme" as const;
...
export function getBookingHref(locale: AppLocale): string {
  if (CANONICAL_BOOKING_URL) {
    try {
      const url = new URL(CANONICAL_BOOKING_URL);
