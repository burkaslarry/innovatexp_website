  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        question: "服務方案點樣起步？",
        answer:
          "由淺入深，按部就班：\n30 日 Discovery Sprint（HK$6,800）\n3 個月 Foundation（HK$26,000）\n6 個月 Accelerator（HK$50,000）\n12 個月 Partnership（HK$98,000）\n（註：我哋著重幫你解決實際問題，盲目試用新工具絕對唔係首頁主打。）",
      },
    ],
  },
  finalCta: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "集中幫你看一條最卡手的流程，精準找出漏點、責任不清的地方，以及最值得優先整理的位置。",
      },
      {
        question: "公司很小，值得做嗎？",
        answer:
          "如果公司「一個人請假，整個運作就會卡住」，就非常值得做！小團隊更需要先整理好核心流程。主線由 HK$6,800 的 30 日 Sprint 起步，風險好受控。",
      },
      {
        question: "服務方案怎麼起步？",
        answer:
          "由淺入深，按部就班：\n30 日 Discovery Sprint（HK$6,800）\n3 個月 Foundation（HK$26,000）\n6 個月 Accelerator（HK$50,000）\n12 個月 Partnership（HK$98,000）\n（註：我們著重幫你解決實際問題，盲目試用新工具絕對不是首頁主打。）",
      },
    ],
  },
};
